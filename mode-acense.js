ace.define("ace/mode/acense_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
    "use strict";

    var oop = require("../lib/oop");
    var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;

    var acenseHighlightRules = function() {
    ...
    oop.inherits(acenseHighlightRules, TextHighlightRules);

    exports.acenseHighlightRules = acenseHighlightRules;
});

ace.define("ace/mode/acense",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/acense_highlight_rules","ace/mode/matching_brace_outdent","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/worker/worker_client"], function(require, exports, module) {
    "use strict";

    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var HighlightRules = require("./acense_highlight_rules").acenseHighlightRules;
    ...
    (function() {
        ...
        this.createWorker = function(session) {
            var worker = new WorkerClient(["ace"], "ace/mode/acense_worker", "acenseWorker");
